...
var q5 = new Question(`Which actor sang the 1960s novelty song "Ballad of Bilbo Baggins"?`, ["William Shatner", "Leonard Nimoy", "George Takei", "DeForest Kelley"], "Leonard Nimoy", "q3");
...
function check() {
    if (time !== 0) {
        if (questions[curr].correct === $(this).val()) {
            ...
            if (curr === 4) {
                $("#image").append(image("assets/images/nimoy.gif"));
            }
            else {
